...
INSERT INTO decisao_bloco3 (food_id, nome, decisao, alergenos, motivo) VALUES
  ('food_079', 'Banana', 'sem_alergeno', NULL, NULL),
  ('food_367', 'Cacau em po (sem acucar)', 'sem_alergeno', NULL, NULL),
  ('food_163', 'Peito de frango grelhado', 'sem_alergeno', NULL, NULL),
  ('food_320', 'Azeite de oliva extravirgem', 'sem_alergeno', NULL, NULL),
  ('food_380', 'Molho de tomate caseiro', 'pendente_dado', NULL, 'gordura saturada ~0g e ruido de arredondamento (gordura total so 0,2g), nao descarta laticinio nem outro risco (ex: anchova); depende da receita usada'),
  ('food_260', 'Tapioca (goma preparada)', 'sem_alergeno', NULL, NULL),
  ('food_088', 'Morango', 'sem_alergeno', NULL, NULL),
  ('food_270', 'Pure de abobora (preparado)', 'pendente_dado', NULL, 'sem alergenico se so abobora/azeite/tempero, contem leite se levar manteiga ou creme'),
  ('food_363', 'Mel de abelha', 'sem_alergeno', NULL, NULL),
  ('food_161', 'Grao-de-bico cozido', 'sem_alergeno', NULL, NULL),
  ('food_238', 'Bacon de peru', 'contem', ARRAY['soy'], NULL),
  ('food_028', 'Abacate', 'sem_alergeno', NULL, NULL),
  ('food_497', 'Chia hidratada (Pudim de Chia base)', 'sem_alergeno', NULL, NULL),
  ('food_221', 'Peito de peru defumado', 'contem', ARRAY['soy'], NULL),
  ('food_002', 'Batata doce cozida', 'sem_alergeno', NULL, NULL),
  ('food_405', 'Limonada sem acucar', 'sem_alergeno', NULL, NULL),
  ('food_489', 'Canela em po', 'sem_alergeno', NULL, NULL),
  ('food_487', 'Ervilha em conserva', 'sem_alergeno', NULL, NULL),
  ('food_395', 'Guacamole', 'pendente_dado', NULL, 'gordura saturada (2,1g de 14,7g) compativel tanto com abacate puro quanto com abacate + creme azedo/iogurte, receita comum; macro nao distingue as duas hipoteses'),
  ('food_383', 'Ketchup', 'sem_alergeno', NULL, NULL),
  ('food_430', 'Colageno hidrolisado', 'pendente_dado', NULL, 'fonte nao registrada -- bovino/suino e sem alergenico, peixe/marinho contem peixe'),
  ('food_400', 'Cafe sem acucar', 'sem_alergeno', NULL, NULL),
  ('food_402', 'Agua de coco', 'sem_alergeno', NULL, NULL), -- volta pra ca 2026-09-13, ver nota no A3
  ('food_418', 'Kombucha (tradicional)', 'sem_alergeno', NULL, NULL),
  ('food_464', 'Batata frita Fast-Food', 'sem_alergeno', NULL, NULL),
  ('food_470', 'Salgadinho de pacote (tipo chips de milho)', 'pendente_dado', NULL, 'versao natural sem alergenico, versao com sabor leva leite e frequentemente soja'),
  ('food_490', 'Curcuma (Acafrao-da-terra)', 'sem_alergeno', NULL, NULL),
  ('food_159', 'Feijao preto cozido', 'sem_alergeno', NULL, NULL),
  ('food_037', 'Alface', 'sem_alergeno', NULL, NULL),
  ('food_494', 'Extrato de baunilha', 'sem_alergeno', NULL, NULL),
  ('food_492', 'Oregano seco', 'sem_alergeno', NULL, NULL),
  ('food_350', 'Farinha de grao-de-bico', 'sem_alergeno', NULL, NULL),
  ('food_443', 'Hamburguer vegetal (tipo carne)', 'contem', ARRAY['soy','wheat','gluten'], NULL),
  ('food_378', 'Acai com xarope de guarana', 'sem_alergeno', NULL, NULL),
  ('food_369', 'Geleia de morango', 'sem_alergeno', NULL, NULL),
  ('food_035', 'Aipo (Salsao)', 'sem_alergeno', NULL, NULL),
  ('food_498', 'Spirulina em po', 'sem_alergeno', NULL, NULL),
  ('food_081', 'Mamao', 'sem_alergeno', NULL, NULL),
  ('food_257', 'Biscoito de arroz', 'sem_alergeno', NULL, NULL),
  ('food_493', 'Gengibre em po', 'sem_alergeno', NULL, NULL),
  ('food_401', 'Cha verde sem acucar', 'sem_alergeno', NULL, NULL),
  ('food_346', 'Farinha de linhaca', 'sem_alergeno', NULL, NULL);
...
INSERT INTO decisao_bloco4 (food_id, nome, tokens_banco, tokens_remover, decisao) VALUES
  ('food_220', 'Presunto cozido',              ARRAY['pork'],                          ARRAY['pork'],          'confirma_banco'),
  ('food_251', 'Pao de hamburguer',            ARRAY['gluten','sesame','wheat'],       ARRAY['sesame'],        'confirma_banco'),
  ('food_269', 'Pure de batata (preparado)',   ARRAY['milk'],                          ARRAY['milk'],          'confirma_banco'),
  ('food_279', 'Massa de panqueca (simples)',  ARRAY['egg','gluten','milk','wheat'],   ARRAY['egg','milk'],    'confirma_banco'),
  ('food_393', 'Creme de ricota',              ARRAY['milk'],                          ARRAY['milk'],          'confirma_banco'),
  ('food_013', 'Granola tradicional',          ARRAY['gluten','nuts'],                 ARRAY['nuts'],          'confirma_banco'),
  ('food_245', 'Pao de queijo',                ARRAY['egg','milk'],                    ARRAY['egg'],           'confirma_banco'),
  ('food_262', 'Cuscuz marroquino (cozido)',   ARRAY['gluten','wheat'],                ARRAY['gluten','wheat'],'confirma_banco'),
  ('food_345', 'Farinha de rosca',             ARRAY['gluten','wheat'],                ARRAY['gluten','wheat'],'confirma_banco'),
  ('food_397', 'Tahine (Pasta de gergelim)',   ARRAY['sesame'],                        ARRAY['sesame'],        'confirma_banco'),
  ('food_446', 'Nuggets vegetais',             ARRAY['gluten','soy','wheat'],          ARRAY['soy'],           'confirma_banco'),
  ('food_458', 'Maionese vegana',              ARRAY['soy'],                           ARRAY['soy'],           'confirma_banco');
